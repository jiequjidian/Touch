...
<body style="background-repeat: no-repeat;">
        ...
        <div class="top-nav">
            <div class="container">
                <div class="navbar-header">
                    <a href="javascript:document.location.reload();" class="navbar-brand">数据管理控制平台</a>
                </div>
              <ul class="nav navbar-nav top-navbar-tabs">
                    ...
                    <li class="active"><a class="fa fa-bar-chart" aria-hidden="true"  href="../Server/baobiao.aspx">报表</a> </li>
                   <li class="dropdown">
                        <a class="fa fa-map-signs " href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown"
    ...
    <div class="col-xs-12">
        <div class="col-xs-2 left-menu"> 
            <div id="container" style="min-width:95%;width:100%;height:650px;">
                ...
                <asp:MenuItem Text="新区路泵站" Value="XQL" Selectable="False">
                    <asp:MenuItem Text="新区路日运行报表" Value="新区路日运行报表"></asp:MenuItem>
                    <asp:MenuItem Text="新区路月运行报表" Value="新区路月运行报表"></asp:MenuItem>
                </asp:MenuItem>
